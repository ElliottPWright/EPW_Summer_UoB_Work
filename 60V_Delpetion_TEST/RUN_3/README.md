Data taken with the standard MALTA2 parameters: 36.4um pixel pitch, 512 x 224 pixel matrix, 100um sensor thickness, 25ns integration time. Depletion voltage changed to -60V. (SUSPECTED PREVIOUS RUN_2 DATA CORRUPTED).
